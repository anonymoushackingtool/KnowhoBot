...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/anonymoushackingtool/KnowhoBot)
...
```sh
git clone https://github.com/anonymoushackingtool/KnowhoBot.git
